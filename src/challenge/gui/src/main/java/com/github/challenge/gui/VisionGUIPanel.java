...
public class VisionGUIPanel extends JPanel {
   ...
   **/
  public static final String APPNAME = "VisionGUIPanel";
  ...
  /**
   * <p>Line width of the lines making up a {@link VisionGUIPanel.Pose} in
   * pixels.</p>
   **/
  ...
  /**
   * <p>Default color for historical {@link VisionGUIPanel.Pose}s.</p>
   **/
  ...
  public void initPublisher(ConnectedNode node) {
		publisher = node.newPublisher("command/Motors", rss_msgs.MotionMsg._TYPE);
  }
  ...
  protected class VisionImage extends Glyph {
    ...
    @Override public void paint(Graphics2D g2d) {
      ...
      g2d.drawImage(image, 0, 0, VisionGUIPanel.this);
    }
  }
  ...
  /**
   * <p>All the historical {@link VisionGUIPanel.Pose}s.</p>
   **/
  protected java.util.List<Pose> historicalPoses =
    Collections.synchronizedList(new ArrayList<Pose>());

  /**
   * <p>The one {@link VisionGUIPanel.VisionImage}.</p>
   **/
  ...
  /**
   * <p>Consruct a new VisionGUIPanel.</p>
   *
   ...
   **/
  public VisionGUIPanel(int poseSaveInterval, double maxTV, double maxRV) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        ...
        contentPane.add(VisionGUIPanel.this, "Center");
  ...
  /**
   * <p>Covers {@link #VisionGUIPanel(int, double, double)}, disables driving.</p>
   **/
  public VisionGUIPanel(int poseSaveInterval) {
    this(poseSaveInterval, 0.0, 0.0);
  }

  /**
   * <p>Covers {@link #VisionGUIPanel(int)}, always uses {@link
   * #DEFAULT_POSE_SAVE_INTERVAL}.</p>
   **/
  public VisionGUIPanel() {
  ...
  protected MouseInputListener mouseInputListener =
    ...
    public void doZoom(double newScale, int modifiers) {
      ...
      double scale = VisionGUIPanel.this.scale;
  ...
  protected KeyListener keyListener = new KeyListener() {
    ...
    public synchronized void keyTyped(KeyEvent e) {
      ...
      rss_msgs.MotionMsg msg = publisher.newMessage();
