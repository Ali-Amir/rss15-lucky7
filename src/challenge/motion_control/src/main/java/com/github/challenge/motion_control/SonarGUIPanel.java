 ...
 * @author vona
 **/
public class SonarGUIPanel extends VisionGUIPanel {
  /**
    ...
    public boolean equals(Object other) {
      ...
      switch ( shapeType ) {
        case X_POINT: {
          ...
          if (!shape[0].equals(another.shape[0])) {
            return false;
          }
          break;
        }
   ...
   **/
  public SonarGUIPanel(int poseSaveInterval, double maxTV, double maxRV) {
   ...
   **/
  public SonarGUIPanel(int poseSaveInterval) {
