...
public class WallModel {
  ...
  public void drawWall() {
    ...
    msg.startX = w.getStartPoint().getX();
    msg.startY = w.getStartPoint().getY();
    msg.endX = w.getEndPoint().getX();
    msg.endY = w.getEndPoint().getY();
    Color color = SonarGUI.makeRandomColor();
...
/*
    ...
    */
    ...
    lineMsg.lineB = bNorm;
    lineMsg.lineC = cNorm;
    lineMsg.color.r = lineColor.getRed();
    lineMsg.color.g = lineColor.getGreen();
    lineMsg.color.b = lineColor.getBlue();
